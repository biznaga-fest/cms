...
export interface ApiInfoInfo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    call_for_papers: Schema.Attribute.Component<
      'speakers.call-for-papers',
      false
    >;
    CompanyTicketsNotice: Schema.Attribute.Component<
      'tickets.company-tickets-notice',
      false
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    ...
    footer_links: Schema.Attribute.Component<'footer.footer-link', true> &
      Schema.Attribute.Required;
    hall_of_fame: Schema.Attribute.Component<
      'hall-of-fame.hall-of-fame-item',
      true
    >;
    hosts: Schema.Attribute.Relation<'oneToMany', 'api::host.host'>;
    is_welcome_banner_enabled: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    last_edition: Schema.Attribute.Component<
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::info.info'> &
      Schema.Attribute.Private;
    previous_editions: Schema.Attribute.Component<
      'last-edition.previous-edition',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    raffles: Schema.Attribute.Component<'raffles.raffle', true>;
    schedule: Schema.Attribute.Component<'schedule.schedule-event', true>;
    socials: Schema.Attribute.Component<'socials.socials', false> &
      Schema.Attribute.Required;
    speakers: Schema.Attribute.Relation<'oneToMany', 'api::speaker.speaker'>;
    sponsor_dossier: Schema.Attribute.Component<'sponsors.dossier', false> &
      Schema.Attribute.Required;
    sponsors: Schema.Attribute.Relation<'oneToMany', 'api::sponsor.sponsor'>;
    team: Schema.Attribute.Component<'staff.team-member', true>;
    tickets: Schema.Attribute.Relation<'oneToMany', 'api::ticket.ticket'>;
    tickets_url: Schema.Attribute.String;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    tshirt: Schema.Attribute.Component<'tickets.tshirt', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    venue: Schema.Attribute.Component<'venue.venue', false> &
      Schema.Attribute.Required;
  };
}
...
export interface ApiSponsorSponsor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
    has_featured_page: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    job_offers: Schema.Attribute.Component<'sponsors.job-offer', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sponsor.sponsor'
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    is_sold_out: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    perks: Schema.Attribute.Component<'tickets.perk', true>;
